...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Proyecto_omeyashishashop_CarlosFerrero_df48b84c9dba3f699966_20220306235605_archive.zip';
	const ARCHIVE_SIZE		 = '77794705';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'df48b84-06235605';
    const SECONDARY_PACKAGE_HASH = '6ba2802-06235605';
	const VERSION			 = '1.4.4';
