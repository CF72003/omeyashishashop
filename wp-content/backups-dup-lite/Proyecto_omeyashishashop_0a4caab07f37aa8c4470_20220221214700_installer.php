...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Proyecto_omeyashishashop_0a4caab07f37aa8c4470_20220221214700_archive.zip';
	const ARCHIVE_SIZE		 = '66256674';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0a4caab-21214700';
    const SECONDARY_PACKAGE_HASH = '81a1c60-21214700';
	const VERSION			 = '1.4.4';
